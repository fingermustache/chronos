...
// ExecutionRepository provides read-only access to execution_history.
...
type ExecutionRepository interface {
	...
	// CountBefore returns the number of rows for taskID that sort at or
	...
	CountBefore(ctx context.Context, taskID uuid.UUID, cursorID uuid.UUID) (int, error)
}
